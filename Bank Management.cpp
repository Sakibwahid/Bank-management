...
class Bank {
	...
	void info() {
		...
		cout << "Please enter your account no: "; cin >> cnic;
	...
	void display() {
		...
		cout << "Your account no: " << cnic << endl;
...
c:	cout << "1. Account Open. \n2. Deposit Amount. \n3. Withdraw Amount. \n4. Check Balance. \n";
	cout << "5. Update Record. \n6. Delete Record. \n7. Search Record. \n8. Exit. \n";
		...
		if (key == 1)
		{
			...
			cout << "Please enter your Account No : "; cin >> nam;
			...
			while (u.read((char*)&b, sizeof(b)))
			{
				if (nam == b.cnic)
				{
					...
					cout << "Name of account holder is: " << b.f_name << " " << b.l_name << endl;
					cout << "Current amount is: " << b.amount << endl;
			a:		cout << "Please enter amount you want to withdrawn: "; cin >> am;
					if (am < b.amount)
					{
						b.amount -= am;
					}
		...
		string nam; int count = 0,check=0; char ke, opt;
		cout << "Please enter your account no: "; cin >> nam;
		ifstream u("Reg_users.dat");
		while (u.read((char*)&b, sizeof(b)))
		{
